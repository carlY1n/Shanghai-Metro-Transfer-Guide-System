    ...
    , ui(new Ui::MainWindow)
{
    ...
    this->setWindowTitle(QString("上海地铁换乘指北"));
    this->setWindowIcon(QIcon(QPixmap("D:\\qt_test\\2_subway\\icon\\ShanghaiMetro.png")));
    ...
    //读地铁信息文件
    bool flag=metrosystem->readFile("D:\\qt_test\\2_subway\\Info\\Infomation.txt");
    if(!flag){
